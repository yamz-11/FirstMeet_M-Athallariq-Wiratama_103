 ...
 */
package cemilan.connectdb;

import cemilan.connectdb.exceptions.NonexistentEntityException;
import cemilan.connectdb.exceptions.PreexistingEntityException;
...
public class DaftarmenuJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("cemilan_connectdb_jar_0.0.1-SNAPSHOTPU");
